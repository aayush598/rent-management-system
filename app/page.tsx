      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto space-y-8">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
            Manage your <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-emerald-400">Rental Properties</span> like a pro.
          </h1>
          ...
          <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            {isSignedIn ? (
              <Link href="/dashboard" className="group relative inline-flex items-center justify-center gap-2 bg-white text-slate-950 px-8 py-4 rounded-full font-bold text-lg overflow-hidden transition-transform hover:scale-105 active:scale-95">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 pt-16 border-t border-white/5">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl text-left hover:bg-white/10 transition-colors">
              ...
              <p className="text-slate-400">Calculate electricity based on unit difference automatically. Handle water charges easily.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl text-left hover:bg-white/10 transition-colors">
              ...
              <p className="text-slate-400">Accept rent and bills flexibly. Tenant paying late or partially? We track it perfectly.</p>
            </div>
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 rounded-2xl text-left hover:bg-white/10 transition-colors">
              ...
              <p className="text-slate-400">Generate and share comprehensive, crystal-clear payment receipts instantly.</p>
            </div>
          </div>
        </div>
      </main>
